...
namespace Bookinist.Infrastructure.DebugServices
{
    class DebugBooksRepository : IRepository<Book>
    {
        ...
        public async Task<Book> GetAsync(int id, CancellationToken Cancel = default)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<Book> AddAsync(Book item, CancellationToken Cancel = default)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task UpdateAsync(Book item, CancellationToken Cancel = default)
        {
            throw new NotImplementedException();
        }
